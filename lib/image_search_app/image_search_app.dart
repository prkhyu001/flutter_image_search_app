...
import 'package:newtest/image_search_app/image_api.dart';
import 'package:newtest/image_search_app/model_data/json_data.dart';
import 'package:newtest/image_search_app/storage_api.dart';
        ...
        body: Column(
          children: [
            ...
            FutureBuilder<List<JsonData>>(
              future: _imageApi.getJsonFile(_query),
